...
;(function( $ ){
    ...
    DataTable.prototype = {
        ...
        , details: function () {
            ...
            $('<div class="pull-left"><p>' + o.languages[o.lang].showing + ' ' + start + ' ' + o.languages[o.lang].to + ' ' + end + ' ' + o.languages[o.lang].of + ' ' + o.totalRows + ' ' + o.languages[o.lang].rows + '</p></div>')
                ...
                var $pager = $("<ul></ul>")
                    , $first = $("<li></li>").append(
                        $("<a></a>")
                            .attr("href", "#")
                            .data("page", 1)
                            .html(o.languages[o.lang].pageFirst)
                            .click(function() {
                                o.currentPage = 1;
                                that.render();
                                return false;
                    ...
                    , $previous = $("<li></li>").append(
                        $("<a></a>")
                            ...
                            .text(o.languages[o.lang].pagePrev)
                            .click(function() {
                                o.currentPage -= 1;
                    ...
                    , $next = $("<li></li>").append(
                        $("<a></a>")
                            .attr("href", "#")
                            .data("page", o.currentPage + 1)
                            .text(o.languages[o.lang].pageNext)
                            .click(function() {
                                o.currentPage += 1;
                    ...
                    , $last = $("<li></li>").append(
                        $("<a></a>")
                            ...
                            .html(o.languages[o.lang].pageLast)
                            .click(function() {
    ...
    function _initColumnModal() {
        ...
        if(!this.$column_modal) {
            ...
            this.$column_modalheader = $("<div></div>")
                ...
                .append(
                    $("<h3></h3>")
                        .text(o.languages[o.lang].toggleColumns)
                );
                    ...
                    $('<div class="pull-left"></div>')
                        .append(
                            $('<div class="btn-group"></div>')
                                .append(
                                    $('<a href="#" class="btn">' + o.languages[o.lang].checkAll + '</a>')
                                        .click(function() {
                                    ...
                                    , $('<a href="#" class="btn">' + o.languages[o.lang].none + '</a>')
                                        .click(function() {
        ...
        $toggle
            .addClass("btn")
            .data("toggle", "modal")
            .attr("title", o.languages[o.lang].columnDialog)
    ...
    function _initFilterModal() {
        ...
        $toggle
            ...
            .data("toggle", "modal")
            .attr("href", "#")
            .attr("title", o.languages[o.lang].filterDialog)
    ...
    function _initPerPage() {
        ...
        var $perpage_select = $("<a></a>")
            ...
            .attr("title", o.languages[o.lang].changeRows)
    ...
    function _initTableInfo() {
        ...
        $($info).popover({
            ...
            , content: $('<dl></dl>').append(
                $page_sort.length > 0 ? '<dt><i class="icon-th-list"></i> ' + o.languages[o.lang].sort + ':</dt><dd>' + $page_sort.join(", ") + '</dd>' : ''
                , $page_filter.length > 0 ? '<dt><i class="icon-filter"></i> ' + o.languages[o.lang].sort + ':</dt><dd>' + $page_filter.join(", ") + '</dd>' : ''
            )
        });
    ...
    function _initOverflowToggle() {
        ...
        $overflow
            .addClass("btn")
            .attr("href", "#")
            .attr("title", o.languages[o.lang].toggleSize)
    ...
    $.fn.datatable.defaults = {
        ...
        , languages: {
            en : {
                ...
                toggleSize : 'Toggle the size of the table to fit the data or to fit the screen.',
                sort : 'Sort',
                filter : 'Filter',
                changeRows: 'Change the number of rows per page.',
                filterDialog: 'Open the filter dialog.',
                columnDialog: 'Choose which columns you would like to display.',
                close: 'Close',
                save : 'Save',
                none: 'None',
                checkAll: 'Check All',
                toggleColumns: 'Toggle Columns',
                pageFirst: '&larr; First',
                pagePrev: 'Prev',
                pageNext: 'Next',
                pageLast: 'Last &rarr;',
                showing: 'Showing',
            ...
            ru : {
                empty: 'Нет данных',
                toggleSize : 'Переключить вывод таблицы между размером данных или размером экрана.',
                sort : 'Сортировка',
                filter : 'Фильтрация',
                changeRows: 'Изменить количество выводимых строк.',
                filterDialog: 'Настроить фильтрацию.',
                columnDialog: 'Настроить отображение столбцов.',
                close: 'Закрыть',
                save : 'Сохранить',
                none: 'Отменить все',
                checkAll: 'Выбрать все',
                toggleColumns: 'Изменить столбцы',
                pageFirst: '&larr; Первая',
                pagePrev: 'Назад',
                pageNext: 'Далее',
                pageLast: 'Последняя &rarr;',
                showing: 'Показано с',
                to: 'по',
                of: 'из',
                rows: 'записей'
